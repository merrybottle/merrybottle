(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [405],
  {
    ...
    4010: function (e, t, r) {
      ...
      let a = {
        ...
        F = (e) => (0, o.gh)('height', e, S),
        P = (e) => (0, o.gh)('min-height', e, S),
        ...
        E = s.ZP.div.withConfig({ componentId: 'sc-c066f7db-0' })(
          ...
          (e) => {
            ...
            return (
              ...
              void 0 !== e.$height &&
                (t = (0, s.iv)(['', '', ''], t, F(e.$height))),
              void 0 !== e.$maxHeight &&
                (t = (0, s.iv)(['', '', ''], t, N(e.$maxHeight))),
              void 0 !== e.$minHeight &&
                (t = (0, s.iv)(['', '', ''], t, P(e.$minHeight))),
      ...
      let e_ = (e) => {
        ...
        eS = { lg: '48px', md: '32px', sm: '28px' },
        ez = { lg: '64px', md: '46px', sm: '42px' },
        eZ = (e) => eS[e],
        eT = (e) => ez[e],
        eF = s.ZP.h1.withConfig({ componentId: 'sc-6a1c2baa-0' })(
          ['margin:0;padding:0;', ' ', ' ', ' ', ' ', ' ', ''],
          (e) => {
            let { $color: t = 'dark', $opacity: r } = e;
            return void 0 !== r
          ...
          (e) => {
            let { $size: t } = e;
            return (0, o.gh)('lineHeights', t, eT);
          },
          (e) => {
            let { $variant: t } = e;
            return ee(t);
      ...
      let to = (e) => {
        ...
        ta = (0, s.ZP)(E)
          ...
          .withConfig({ componentId: 'sc-25bab9db-0' })(
          [
        ...
        tl = s.ZP.a.withConfig({ componentId: 'sc-25bab9db-1' })(
          [
        ...
        tm = s.ZP.div.withConfig({ componentId: 'sc-49b654ab-2' })(
          [
            'animation:',
          ...
          (e) => {
            ...
            return t.includes('SLIDES')
              ? (0, s.iv)(
                  [
                    '',
                    ' border-radius:50%;height:15vw;width:15vw;',
                    ' ',
                    ' ',
                    ' ',
        ...
        t$ = (0, s.ZP)(E)
          ...
          .withConfig({ componentId: 'sc-49b654ab-3' })([
          'line-height:0;aspect-ratio:1 / 1;',
        ]),
        tf = s.ZP.div.withConfig({ componentId: 'sc-49b654ab-4' })(
          [
            'animation:',
      ...
      let tj = (0, s.ZP)(E)
          .attrs({ $width: '100%' })
          .withConfig({ componentId: 'sc-4c1f0bdb-0' })([
          'position:relative;height:100%;',
        ]),
        tk = (0, s.ZP)(E)
          .attrs({ $height: '100vh', $overflow: 'hidden' })
          .withConfig({ componentId: 'sc-4c1f0bdb-1' })(
          ['padding-bottom:', 'px;'],
          120,
        ),
        tv = s.ZP.button.withConfig({ componentId: 'sc-4c1f0bdb-2' })(
          [
        ...
        tw = s.ZP.span.withConfig({ componentId: 'sc-4c1f0bdb-3' })(
          [
            '',
            ' ',
            ' ',
        ...
        ty = (0, s.ZP)(E).withConfig({ componentId: 'sc-4c1f0bdb-4' })(
          [
            'border:3px solid ',
            ';',
          ...
          children: [
            (0, i.jsx)(tb(), {
              children: (0, i.jsx)('title', {
                children: 'you.are@merrybottle.com',
              }),
            }),
            (0, i.jsx)(E, {
              $maxWidth: { xl: 1200 },
  ...
  function (e) {
    e.O(0, [607, 888, 774, 179], function () {
      return e((e.s = 8312));
    }),
      (_N_E = e.O());
  },
